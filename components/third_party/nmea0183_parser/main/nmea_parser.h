...
// Provide sane defaults when sdkconfig entries are missing (e.g. if Kconfig was not picked up yet)
...
#define CONFIG_NMEA_PARSER_TASK_PRIORITY 12
#endif

#ifndef CONFIG_NMEA_PARSER_UART_RXD
#define CONFIG_NMEA_PARSER_UART_RXD 34
#endif
