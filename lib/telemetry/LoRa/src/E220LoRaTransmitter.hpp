 ...
 */
    ...
    E220LoRaTransmitter(HardwareSerial &serial, byte auxPin, byte m0Pin, byte m1Pin) : transmitter(&serial, auxPin, m0Pin, m1Pin, UART_BPS_RATE_9600) {};
#else
    E220LoRaTransmitter(HardwareSerial &serial, byte auxPin, byte m0Pin, byte m1Pin) : transmitter(&serial, auxPin, m0Pin, m1Pin, UART_BPS_RATE_115200) {};
#endif
/**
 * @brief Construct a new E220LoRaTransmitter object
 *
 ...
 */
#ifdef TRANSMITTER_CONFIG_MODE_ENABLE
    E220LoRaTransmitter(HardwareSerial &serial, byte auxPin) : transmitter(&serial, auxPin, -1, -1, UART_BPS_RATE_9600) {};
#else
    E220LoRaTransmitter(HardwareSerial &serial, byte auxPin) : transmitter(&serial, auxPin, -1, -1, UART_BPS_RATE_115200) {};
#endif
/**
 * @brief Construct a new E220LoRaTransmitter object
 *
 ...
 */
#ifdef TRANSMITTER_CONFIG_MODE_ENABLE
    E220LoRaTransmitter(HardwareSerial &serial) : transmitter(&serial, -1, -1, -1, UART_BPS_RATE_9600) {};
#else
    E220LoRaTransmitter(HardwareSerial &serial) : transmitter(&serial, -1, -1, -1, UART_BPS_RATE_115200) {};
#endif
    /**
